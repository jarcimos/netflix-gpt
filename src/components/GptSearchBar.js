...
const GptSearchBar = () => {
  ...
  const handleGptSearchClick = async () => {
    ...
    const gptQuery =
      ...
      ". only give me names of 5 movies, comma seperated like the example result given ahead. Example Result: The Avengers, Deep, Leo, Napoleon, The Creator";
    ...
    console.log('results', tmdbResult);
